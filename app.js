...
//it invoked objects elements (the object we are built it)
// 2. What is "this" when joe.scopeArrow() is invoked?
//it invoked the global window object
// 3. Explain why "this" is different when an arrow function is used.
//arrow functions retain the this value of the enclosing functional scope ,so best to avoid using an arrow function in a constructor